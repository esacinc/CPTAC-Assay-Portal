...
class LabkeyApi {
     ...
     * Get Curve Type Data
    */
    public function getCurveTypeData(
        $panorama_authentication_cookie = false
        , $schemaName
        , $queryName
        , $peptideModifiedSequence
        ...
        return $this->_doCall(
            ...
            , array(
                'schemaName' => $schemaName
            , 'query.queryName' => $queryName
            , 'query.PeptideModifiedSequence~eq' => $peptideModifiedSequence
            , 'query.columns' => 'PeptideId/PeptideGroupId/Label,PeptideId/PeptideModifiedSequence,IsotopeLabelId/Name,IsotopeLabelId/Standard'
            )
            , $laboratory_abbreviation
            , $celllysate_path
            , $library
     ...
     * the unit is added as an argument
     */
    ...
    */
    ...
    protected function buildUrl(
        ...
        switch ($query_name) {
            ...
            case 'ResponseCurveQueryV2': // response curve images
            ...
            case 'QCAnalysisQueryV2': // validation sample images and data
            case 'ResponseCurveAnalysis': // lod/loq and curve fit data
            case 'ResponseCurveAnalysisV2': // lod/loq and curve fit data
                if ($path == '/executeQuery.view') {
                    $url = $this->labkey_config['query_endpoint_live'] . $laboratory_abbreviation . '/' . $celllysate_path . '/' . $library . $path;
                } else {
                    $url = $this->labkey_config['project_endpoint_live'] . $laboratory_abbreviation . '/' . $celllysate_path . '/' . $library . $path;
