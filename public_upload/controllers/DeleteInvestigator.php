...
class DeleteInvestigator extends Controller
{


  function delete_investigator(Request $request, Response $response, $args = [])
  {
    ...
    //$this->container->get('logger')->info("inside delete investigator");

    $post = $request->getParsedBody();


    $data = $import->delete_investigator( $post['investigator_id'] );
