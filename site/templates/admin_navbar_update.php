            ...
            <div style="flex:8">
                <div id="block-block-1">
                    <div class="">
                         ...
                         <div class="content" > <a href="https://proteomics.cancer.gov/">
...
<div role="document" class="page">
    <div class="">
        ...
        <header role="banner" class="l-header">
            ...
            <section class="container">
                <div class="row">
                  <div class="col-sm-12 col-md-12 col-lg-12 menu_bar">
                            ...
                            <div class="content" >
                                <div class="menu-block-wrapper menu-block-4 menu-level-2">
                                    <ul class="menu pull-left">
                                        ...
                                        <li class="expanded">
                                            <span class="nolink">
                                                <i aria-hidden="true" class="fa fa-fw fa-2x fa-sign-out"></i>
                                                <a href="{{ logout_url }}">Logout</a>
                                            </span>
                          ...
                          <div class="content">
                              <div class="menu-block-wrapper menu-block-4 menu-level-2">
                                  <ul class="menu pull-right">
                                    <li class="expanded logout">
                                    <span class="nolink">
                                      <i aria-hidden="true" class="fa fa-fw fa-2x"></i>
                                        <a href="{{ logout_url }}" style="color:grey;">Logout</a>
                                     </span>
                                     </li>
                                  </ul>
                              </div>
