...
$swpg_module_settings = array(
  "module_name" => "Manage Assays"
  ,"module_description" => "Manage imported assays (only available to NCI)"
  ,"module_icon_css_classes" => "fa fa-fw fa-check-square"
  ,"sort_order" => 1
  ...
  ,"pages" => array(
    array(
      "label" => "Manage Assay Approvals"
      ,"path" => "/"
      ,"display" => $apply_permissions("assay_approval", "manage_access")
    )
  )
  ,"datatables" => array(
    ...
    array(
      ...
      ,"fields" => array(
        ...
        ,"peptide_sequence" => array("label" => "Peptide Sequence", "comparison_default" => "start_with", "filter" => false, "show_column_toggle" => false, "initially_hidden" => false, "filter_type" => "text", "data_type" => "text")
