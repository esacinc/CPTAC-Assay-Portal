    ...
    function getAppInstance() {
        ...
        $config = [
            'settings' => [
                ...
                , "mode" => (!$final_global_template_vars["is_dev"] ? "production" : "development")
                , "debug" => $final_global_template_vars["is_dev"]
                , 'cookies.domain' => $final_global_template_vars["server_name"]
                , 'cookies.httponly' => true
                , 'cookies.secure' => $final_global_template_vars["request_https"]

                , 'db' => [
                    'driver' => 'mysql',
                    'host' => '192.168.186.132',
                    'database' => 'cptac_assay',
                    'username' => 'cptac_assay',
                    'password' => 'esac_cptac',
                    'charset' => 'utf8',
                    'strict' => true
                ]
                ...
                , 'assays-admin-db' => [
                    'driver' => 'mysql',
                    'host' => 'dev3.esacinc.com',
                    'database' => 'cptac_assay_admin',
                    'username' => 'cptac_assay',
                    'password' => 'esac_cptac',
                    'charset' => 'utf8'
                ]
                ...
                , 'logger' => [
                    ...
                    'path' => 'php://sdtout',
                    //'path' => $_SERVER["DOCUMENT_ROOT"] . '/logs/cptac_assay.log'
                ],
            ],
        ];
        // Prepare app
        ...
        $container['db'] = function ($container) {
            ...
            $capsule->addConnection($container['settings']['assays-submit-db'], 'assays-submit-db');
            $capsule->addConnection($container['settings']['dev4-db'], 'dev4-db');
            $capsule->addConnection($container['settings']['assays-admin-db'], 'assays-admin-db');
